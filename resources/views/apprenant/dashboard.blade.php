...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        <!-- Lien Home -->
        <li>
            <a href="{{ route('home') }}" data-tooltip="Accueil">
        ...
        <li>
            <a href="{{ route('apprenant.dashboard') }}" class="active" data-tooltip="Tableau de bord">
                <i class="bi bi-speedometer2"></i>
                <span>Tableau de bord</span>
            </a>
        </li>
        <li>
            <a href="{{ route('apprenant.formations') }}" data-tooltip="Mes formations">
        ...
        <li>
            <a href="{{ route('apprenant.ressources') }}" data-tooltip="Ressources">
                <i class="bi bi-download"></i>
                <span>Ressources</span>
            </a>
        </li>
        <li>
            <a href="{{ route('apprenant.profil') }}" data-tooltip="Mon profil">
                <i class="bi bi-person"></i>
                <span>Mon profil</span>
            </a>
        </li>
        <li>
            <a href="{{ route('apprenant.parametres') }}" data-tooltip="Paramètres">
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="welcome-card" data-aos="fade-up">
            ...
            <p>
                ...
                @endphp
                Vous avez {{ $formationsCount }} formation(s) en cours.
                Continuez votre apprentissage dès maintenant !
            </p>
            <a href="{{ route('apprenant.continuer') }}" class="continue-btn">
                <i class="bi bi-play-circle"></i>
        ...
        <div class="stats-grid">
            <div class="stat-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="stat-info">
                    <h4>{{ $stats['total_inscriptions'] }}</h4>
            ...
            <div class="stat-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="stat-info">
                    <h4>{{ $stats['formations_en_cours'] }}</h4>
                    <p>En cours</p>
                </div>
            </div>
            <div class="stat-card" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="stat-info">
                    <h4>{{ $stats['formations_terminees'] }}</h4>
                    <p>Terminées</p>
                </div>
            </div>
        ...
        <div class="section-title" data-aos="fade-up">
            ...
            <a href="{{ route('apprenant.formations') }}" class="view-all">
                Voir tout <i class="bi bi-arrow-right"></i>
            </a>
        </div>

        <div class="courses-grid">
            @forelse($formationsEnCoursList as $formation)
            <div class="course-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 100 }}">
                <div class="course-image" style="background-image: url('{{ $formation->image_url ?? 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' }}')">
                    <span class="course-progress-badge">{{ $formation->pivot->progression ?? rand(10, 90) }}%</span>
                </div>
                <div class="course-content">
                    ...
                    <div class="progress-container">
                        <div class="progress-info">
                            ...
                            <span>{{ $formation->pivot->progression ?? rand(10, 90) }}%</span>
                        </div>
                        <div class="progress-bar-custom">
                            <div class="progress-fill" style="width: {{ $formation->pivot->progression ?? rand(10, 90) }}%"></div>
                        </div>
                    </div>
                    <a href="{{ route('apprenant.formation.show', $formation->id) }}" class="continue-link">
            ...
            <div class="col-12">
                <div class="empty-state text-center py-5">
                    ...
                    <a href="{{ route('formations') }}" class="btn btn-primary-modern mt-3">
        ...
        <div class="col-md-7">
            <div class="section-title" data-aos="fade-up">
                ...
                <a href="{{ route('apprenant.activite') }}" class="view-all">
                    Voir tout <i class="bi bi-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="activity-list" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="activity-item">
                    <div class="activity-icon">
                        <i class="bi bi-{{ $activite->icone ?? 'play-circle' }}"></i>
                    </div>
        ...
        <div class="col-md-5">
            <div class="section-title" data-aos="fade-up">
                ...
                <a href="{{ route('apprenant.ressources') }}" class="view-all">
                    Voir tout <i class="bi bi-arrow-right"></i>
                </a>
            </div>
            ...
            <div class="resources-grid" data-aos="fade-up" data-aos-delay="100">
                ...
                @forelse($ressourcesRecentes as $ressource)
                <div class="resource-item">
                    <div class="resource-icon">
                        <i class="bi bi-file-{{ $ressource->type == 'video' ? 'play' : 'text' }}"></i>
                    </div>
                    <div class="resource-info">
                        <h4>{{ Str::limit($ressource->description ?? 'Ressource', 20) }}</h4>
                        <p>{{ $ressource->module->formation->titre ?? 'Formation' }}</p>
                    </div>
                    <a href="{{ $ressource->url }}" target="_blank" class="resource-download">
