                ...
                <?php if(auth()->guard()->check()): ?>
                    <li class="nav-item dropdown ms-lg-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <?php elseif(auth()->user()->role === 'formateur'): ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('formateur.dashboard')); ?>">
                                        <i class="bi bi-easel me-2"></i>Dashboard Formateur
                                    </a>
                                </li>
                            <?php else: ?>
                                <li>
                                    <a class="dropdown-item" href="<?php echo e(route('apprenant.dashboard')); ?>">
...
<main>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6" data-aos="fade-right">
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn-outline-primary-modern">
                            <i class="bi bi-person-plus me-2"></i>S'inscrire gratuitement
                        </a>
                    </div>
                    <div class="hero-stats">
                        <div class="stat-item">
                            <h3><?php echo e($stats['total_apprenants'] ?? 0); ?>+</h3>
                            <p>Apprenants</p>
                        </div>
                        <div class="stat-item">
                            <h3><?php echo e($stats['total_formations'] ?? 0); ?>+</h3>
                            <p>Formations</p>
                        </div>
                        <div class="stat-item">
                            <h3><?php echo e($stats['total_formateurs'] ?? 0); ?>+</h3>
                            <p>Experts</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="search-section">
        <div class="container">
            <div class="search-card" data-aos="fade-up">
                <form action="<?php echo e(route('formations.search')); ?>" method="GET" class="search-input-group">
                    <input type="text" name="search" placeholder="Rechercher une formation..." value="<?php echo e(request('search')); ?>">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                        <div class="formation-card">
                            <div class="card-image">
                                <img src="<?php echo e($formation->image_url ?? 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80'); ?>" 
                            ...
                            <div class="card-content">
                                <h5 class="card-title"><?php echo e($formation->titre); ?></h5>
                                <p class="card-description"><?php echo e(Str::limit($formation->description ?? '', 100)); ?></p>
                                ...
                                <div class="card-meta">
                                    ...
                                    <span class="card-duration">
                                        ...
                                        <?php echo e($formation->date_debut ? \Carbon\Carbon::parse($formation->date_debut)->format('d/m/Y') : 'Date à définir'); ?>

                                    </span>
                                </div>

                                <div class="card-footer">
                                    <a href="<?php echo e(route('formations.show', $formation->id)); ?>" class="btn-details">
                                        Voir détails
                                    </a>
                                </div>
                            </div>
    ...
    <?php if(isset($formationsPopulaires) && $formationsPopulaires->count() > 0): ?>
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = $formationsPopulaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="formation-card">
                        ...
                        <div class="card-content">
                            <h5 class="card-title"><?php echo e($formation->titre); ?></h5>
                            <p class="card-description"><?php echo e(Str::limit($formation->description ?? '', 80)); ?></p>
                            ...
                            <div class="card-meta">
                                ...
                                <span class="card-duration">
                                    ...
                                    <?php echo e($formation->inscriptions_count ?? 0); ?> inscrits
                                </span>
                            </div>
    ...
    <!-- Top Formateurs -->
    <?php if(isset($topFormateurs) && $topFormateurs->count() > 0): ?>
    <section id="formateurs" class="py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = $topFormateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $formateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="formateur-card">
                        <div class="formateur-avatar">
                            <?php echo e(strtoupper(substr($formateur->nom, 0, 2))); ?>

                        </div>
                        <h5 class="mt-3"><?php echo e($formateur->nom); ?></h5>
                        <p class="text-muted small"><?php echo e($formateur->formations_count ?? 0); ?> formations</p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <!-- Témoignages -->
    <?php if(isset($temoignages) && $temoignages->count() > 0): ?>
    <section class="py-5 bg-light">
        <div class="container">
            <div class="section-title" data-aos="fade-up">
                <span class="badge">
            ...
            <div class="row g-4">
                <?php $__currentLoopData = $temoignages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $avis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                    <div class="temoignage-card">
                        <div class="temoignage-header">
                            <div class="temoignage-avatar">
                                <?php echo e(strtoupper(substr($avis->user->nom ?? 'A', 0, 2))); ?>

                            </div>
                            <div class="temoignage-info">
                                <h5><?php echo e($avis->user->nom ?? 'Apprenant'); ?></h5>
                                <p><?php echo e($avis->formation->titre ?? 'Formation'); ?></p>
                            </div>
                        </div>
                        <div class="temoignage-rating">
                            <?php for($i = 1; $i <= 5; $i++): ?>
                                <i class="bi bi-star<?php echo e($i <= ($avis->note ?? 0) ? '-fill text-warning' : ''); ?>"></i>
                            <?php endfor; ?>
                        </div>
                        <p class="temoignage-text">"<?php echo e($avis->commentaire ?? 'Super formation !'); ?>"</p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
</html><?php /**PATH C:\Users\HP\plateforme-formation\resources\views/home.blade.php ENDPATH**/ ?>