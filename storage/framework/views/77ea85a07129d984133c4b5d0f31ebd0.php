...
<?php $__env->startSection('title', 'Paramètres - Administration'); ?>
<?php $__env->startSection('page-title', 'Paramètres de la plateforme'); ?>
<?php $__env->startSection('page-subtitle', 'Admin / Paramètres'); ?>
...
<div class="row">
    <div class="col-lg-8 mx-auto">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.parametres.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    
                    <div class="mb-3">
                        <label for="site_name" class="form-label">Nom du site</label>
                        <input type="text" class="form-control" id="site_name" name="site_name" value="<?php echo e($settings['site_name'] ?? 'EduForm'); ?>">
                    </div>
                    
                    <div class="mb-3">
                        <label for="site_email" class="form-label">Email de contact</label>
                        <input type="email" class="form-control" id="site_email" name="site_email" value="<?php echo e($settings['site_email'] ?? 'contact@eduform.com'); ?>">
                    </div>
                    
                    <div class="mb-3">
                        <label for="site_description" class="form-label">Description du site</label>
                        <textarea class="form-control" id="site_description" name="site_description" rows="3"><?php echo e($settings['site_description'] ?? 'Plateforme de formation en ligne'); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="allow_registrations" name="allow_registrations" <?php echo e(($settings['allow_registrations'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="require_email_verification" name="require_email_verification" <?php echo e(($settings['require_email_verification'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="enable_notifications" name="enable_notifications" <?php echo e(($settings['enable_notifications'] ?? true) ? 'checked' : ''); ?>>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.parametres.security')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    
                    <div class="mb-3">
                        <label for="min_password_length" class="form-label">Longueur minimale du mot de passe</label>
                        <input type="number" class="form-control" id="min_password_length" name="min_password_length" value="<?php echo e($settings['min_password_length'] ?? 8); ?>" min="6" max="20">
                    </div>
                    
                    <div class="mb-3">
                        <label for="max_login_attempts" class="form-label">Tentatives de connexion max avant blocage</label>
                        <input type="number" class="form-control" id="max_login_attempts" name="max_login_attempts" value="<?php echo e($settings['max_login_attempts'] ?? 5); ?>" min="3" max="10">
                    </div>
                    
                    <div class="mb-3">
                        <label for="session_timeout" class="form-label">Durée de session (minutes)</label>
                        <input type="number" class="form-control" id="session_timeout" name="session_timeout" value="<?php echo e($settings['session_timeout'] ?? 120); ?>" min="30" max="480">
                    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.parametres.email')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    
                    <div class="mb-3">
                        <label for="mail_driver" class="form-label">Driver mail</label>
                        <select class="form-select" id="mail_driver" name="mail_driver">
                            <option value="smtp" <?php echo e(($settings['mail_driver'] ?? 'smtp') == 'smtp' ? 'selected' : ''); ?>>SMTP</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mail_host" name="mail_host" value="<?php echo e($settings['mail_host'] ?? 'smtp.gmail.com'); ?>">
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="mail_port" class="form-label">Port</label>
                            <input type="number" class="form-control" id="mail_port" name="mail_port" value="<?php echo e($settings['mail_port'] ?? 587); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="mail_username" name="mail_username" value="<?php echo e($settings['mail_username'] ?? ''); ?>">
                    </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="d-flex gap-3">
                    <form action="<?php echo e(route('admin.maintenance.cache')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
                    ...
                    <form action="<?php echo e(route('admin.maintenance.backup')); ?>" method="POST" class="d-inline">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="maintenanceModeModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.maintenance.toggle')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\plateforme-formation\resources\views/admin/parametres.blade.php ENDPATH**/ ?>