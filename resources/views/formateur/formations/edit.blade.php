...
<head>
    ...
    <title>Modifier la formation - Formateur - EduForm</title>
    ...
    <main class="main-content">
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <a href="{{ route('formateur.formations.show', $formation->id) }}" class="btn-view">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date"
                            ...
                            value="{{ old('date_debut', $formation->date_debut ? \Carbon\Carbon::parse($formation->date_debut)->format('Y-m-d') : '') }}"
                            required>
                        @error('date_debut')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date"
                            ...
                            value="{{ old('date_fin', $formation->date_fin ? \Carbon\Carbon::parse($formation->date_fin)->format('Y-m-d') : '') }}"
                            required>
                        @error('date_fin')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-12">
                        ...
                        <input type="url"
                            ...
                            value="{{ old('image_url', $formation->image_url) }}"
                        ...
                        <div class="mt-2">
                            <img src="{{ $formation->image_url }}" alt="Aperçu" class="preview-image" id="imagePreview">
                        </div>
                        @endif
                    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="bg-light p-4 rounded-3">
                        <h6 class="fw-bold mb-3"><i class="bi bi-files me-2 text-primary"></i>Statistiques</h6>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Modules :</span>
                            <span class="fw-bold">{{ $formation->modules->count() }}</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Contenus :</span>
                            <span class="fw-bold">{{ $formation->modules->sum(function($m) { return $m->contenus->count(); }) }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Inscriptions :</span>
                            <span class="fw-bold">{{ $formation->inscriptions->count() }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="bg-light p-4 rounded-3">
                        <h6 class="fw-bold mb-3"><i class="bi bi-info-circle me-2 text-primary"></i>Dates</h6>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Créée le :</span>
                            <span class="fw-bold">{{ $formation->created_at->format('d/m/Y') }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Dernière mise à jour :</span>
                            <span class="fw-bold">{{ $formation->updated_at->format('d/m/Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('imageUrlInput')?.addEventListener('input', function(e) {
            ...
            if (preview) {
                ...
                // Créer un nouvel élément d'aperçu s'il n'existe pas
