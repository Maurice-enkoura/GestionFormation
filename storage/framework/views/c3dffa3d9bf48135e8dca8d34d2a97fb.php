    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <p class="text-muted small">Membre depuis <?php echo e($user->created_at->format('d/m/Y')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('apprenant.profil.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.apprenant', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\plateforme-formation\resources\views/apprenant/profil/index.blade.php ENDPATH**/ ?>