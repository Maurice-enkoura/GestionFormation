...
@section('page-subtitle', 'Admin / Statistiques')
...
<div class="row g-4 mb-4">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <small class="text-success">
                    <i class="bi bi-arrow-up"></i> +{{ $stats['nouveaux_users'] ?? 0 }} ce mois
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <p>Formations</p>
                <small class="text-muted">{{ $stats['formations_publiees'] ?? 0 }} publiées</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <p>Formateurs</p>
                <small class="text-success">
                    <i class="bi bi-arrow-up"></i> {{ $stats['formateurs_actifs'] ?? 0 }} actifs
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h4>{{ $stats['total_apprenants'] ?? 0 }}</h4>
                <p>Apprenants</p>
                <small class="text-success">{{ $stats['apprenants_actifs'] ?? 0 }} actifs</small>
            </div>
        </div>
    </div>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="text-warning">
                                    {{ number_format($formation->note_moyenne, 1) }} ★
                                </span>
                            </td>
                        </tr>
                        @empty
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $formateur->total_apprenants ?? 0 }}</td>
                            <td>
                                <span class="text-warning">
                                    {{ number_format($formateur->note_moyenne, 1) }} ★
                                </span>
                            </td>
                        </tr>
                        @empty
                    ...
                    <div class="list-group-item">
                        <div class="d-flex align-items-center">
                            <div class="activity-icon me-3">
                                <i class="bi bi-{{ $activite['icone'] ?? 'circle' }}"></i>
                            </div>
                            <div class="flex-grow-1">
                                <strong>{{ $activite['titre'] }}</strong>
                                <p class="mb-0 text-muted small">{{ $activite['description'] }}</p>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(usersCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        {{ $stats['total_apprenants'] ?? 65 }},
                        {{ $stats['total_formateurs'] ?? 25 }},
                        {{ $stats['total_admins'] ?? 10 }}
                    ],
