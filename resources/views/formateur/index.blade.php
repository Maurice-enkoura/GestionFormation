...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="{{ route('formateur.dashboard') }}" class="active">
    ...
    <main class="main-content">
        ...
        <div class="top-bar">
            ...
            <div class="user-info">
                ...
                <div class="user-profile">
                    ...
                    <div>
                        <div class="fw-bold">{{ $formateur->nom }}</div>
                        <div class="text-secondary small">{{ ucfirst($formateur->role) }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="welcome-card">
            <h3>Bonjour, {{ explode(' ', $formateur->nom)[0] }} ! 👋</h3>
            <p>
                Vous avez {{ $stats['total_formations'] }} formation(s) active(s)
                et {{ $stats['total_apprenants'] }} apprenant(s) au total.
            </p>
        ...
        <div class="formations-grid">
            ...
            @forelse($formations as $formation)
                <div class="formation-card">
                    <div class="formation-image" style="background-image: url('{{ $formation->image_url ?? 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80' }}')">
                    </div>
                    <div class="formation-content">
                        <h4 class="formation-title">{{ $formation->titre }}</h4>
                        <div class="formation-stats">
                            <span><i class="bi bi-people"></i> {{ $formation->inscriptions_count ?? 0 }}</span>
                            <span><i class="bi bi-star-fill text-warning"></i> 0</span>
                        </div>
                        <div class="formation-footer">
                            <a href="{{ route('formateur.formations.edit', $formation->id) }}" class="btn-edit">Modifier</a>
                            <small class="text-muted">{{ $formation->date_debut ? \Carbon\Carbon::parse($formation->date_debut)->format('d/m/Y') : '' }}</small>
                        </div>
                    </div>
                </div>
            @empty
                <div class="col-12">
                    <div class="empty-state">
                        ...
                        <a href="{{ route('formateur.formations.create') }}" class="btn btn-primary mt-2">
                            Créer une formation
                        </a>
                    </div>
                </div>
