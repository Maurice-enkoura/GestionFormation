...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Espace Apprenant - EduForm'); ?></title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li>
                <a href="<?php echo e(route('apprenant.dashboard')); ?>" class="<?php echo e(request()->routeIs('apprenant.dashboard') ? 'active' : ''); ?>" data-tooltip="Tableau de bord">
                    <i class="bi bi-speedometer2"></i>
                    <span>Tableau de bord</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('apprenant.formations')); ?>" class="<?php echo e(request()->routeIs('apprenant.formations') || request()->routeIs('apprenant.formation.show') ? 'active' : ''); ?>" data-tooltip="Mes formations">
            ...
            <li>
                <a href="<?php echo e(route('apprenant.ressources')); ?>" class="<?php echo e(request()->routeIs('apprenant.ressources') ? 'active' : ''); ?>" data-tooltip="Ressources">
                    <i class="bi bi-download"></i>
                    <span>Ressources</span>
                </a>
            </li>
              <li>
        <a href="<?php echo e(route('apprenant.evaluations.index')); ?>" class="<?php echo e(request()->routeIs('apprenant.evaluations*') ? 'active' : ''); ?>" data-tooltip="Mes évaluations">
            ...
            <li>
                <a href="<?php echo e(route('apprenant.parametres')); ?>" class="<?php echo e(request()->routeIs('apprenant.parametres') ? 'active' : ''); ?>" data-tooltip="Paramètres">
...
</html><?php /**PATH C:\Users\HP\plateforme-formation\resources\views/layouts/apprenant.blade.php ENDPATH**/ ?>