...
<div class="top-bar">
    <div class="page-title">
        ...
        <p><?php echo e(now()->locale('fr')->isoFormat('dddd D MMMM YYYY')); ?></p>
    </div>
    <div class="user-info">
        <div class="notifications" data-tooltip="Notifications">
            <i class="bi bi-bell fs-5"></i>
            <span class="badge-notif"><?php echo e(isset($activites) ? $activites->count() : 0); ?></span>
        </div>
        <div class="user-profile" onclick="window.location.href='<?php echo e(route('formateur.profil')); ?>'">
            <div class="user-avatar">
                <?php echo e(strtoupper(substr($formateur->nom ?? 'F', 0, 2))); ?>

            </div>
            <div>
                <div class="fw-bold"><?php echo e($formateur->nom ?? 'Formateur'); ?></div>
