{{-- resources/views/formations/search.blade.php --}}
@extends('layouts.app')
...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p class="lead text-muted">{{ $formations->total() ?? 0 }} formation(s) trouvée(s)</p>
        </div>
    </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-0 shadow-sm rounded-4">
                @if($formation->image_url)
                    <img src="{{ $formation->image_url }}" class="card-img-top rounded-top-4" alt="{{ $formation->titre }}" style="height: 200px; object-fit: cover;">
                @else
