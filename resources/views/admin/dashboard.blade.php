...
@section('page-subtitle', 'Accueil / Dashboard')
...
<div class="row g-4 mb-4">
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <small class="text-success">
                    <i class="bi bi-arrow-up"></i> +{{ $stats['nouveaux_aujourdhui'] ?? 0 }} aujourd'hui
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <p>Formations</p>
                <small class="text-muted">{{ $stats['total_formateurs'] ?? 0 }} formateurs</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <p>Formateurs</p>
                <small class="text-success">
                    <i class="bi bi-arrow-up"></i> {{ $stats['taux_engagement'] ?? 0 }}% actifs
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
        <div class="stat-card">
            ...
            <div class="stat-info">
                <h4>{{ number_format($stats['revenus_mensuels'] ?? 0, 0, ',', ' ') }} €</h4>
    ...
    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="card">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.formations.index') }}" class="btn btn-sm btn-outline-primary">Voir tout</a>
            </div>
            <div class="list-group list-group-flush">
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <p class="mb-1 text-muted small">
                                <i class="bi bi-person me-1"></i> {{ $formation->formateur->nom ?? 'N/A' }}
                            </p>
                        </div>
                        <a href="{{ route('admin.formations.show', $formation) }}" class="btn btn-sm btn-light">
                            <i class="bi bi-eye"></i>
                        </a>
                    </div>
                </div>
        ...
        <div class="card mt-4">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.utilisateurs.index') }}" class="btn btn-sm btn-outline-primary">Voir tout</a>
            </div>
            <div class="list-group list-group-flush">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted">
                                <span class="badge bg-{{ $user->role === 'admin' ? 'danger' : ($user->role === 'formateur' ? 'success' : 'primary') }} bg-opacity-10 text-{{ $user->role === 'admin' ? 'danger' : ($user->role === 'formateur' ? 'success' : 'primary') }} me-2">
                                    {{ ucfirst($user->role) }}
                                </span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(inscriptionsCtx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Inscriptions',
                    data: {{ json_encode($inscriptionsMensuelles ?? [65, 59, 80, 81, 56, 55, 40, 48, 70, 75, 85, 90]) }},
                    borderColor: '#6366f1',
        ...
        new Chart(rolesCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: {{ json_encode($repartitionRoles ?? [65, 25, 10]) }},
